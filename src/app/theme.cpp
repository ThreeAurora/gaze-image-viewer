...
QString appQss() {
    ...
    return QStringLiteral(
        ...
        // 分类筛选器面板(常驻 Dock,非对话框)
        "QWidget#filterPanel QToolButton {"
        "  background: transparent; color: %1; border: 1px solid %4;"
        "  border-radius: 4px; padding: 2px 8px; font-size: 12px;"
        "}"
        "QWidget#filterPanel QToolButton:hover { background: %16; }"
        "QWidget#filterPanel QToolButton:checked"
        "{ border-color: %5; color: %5; font-weight: bold; }"
        ...
        "  color: %1; font-size: 12px; spacing: 4px; background: transparent;"
        "}"
        "QWidget#filterPanel QCheckBox::indicator { width: 13px; height: 13px; }"
        ...
        "  background: transparent; border: 1px solid %4; border-radius: 12px;"
        "}"
