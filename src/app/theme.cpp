...
QString appQss() {
    ...
    const QString tpl = QStringLiteral(
        ...
        "}"
        "QAbstractSpinBox::up-arrow { image: url(:/assets/icons/spin_up.png); }"
        "QAbstractSpinBox::down-arrow { image: url(:/assets/icons/spin_down.png); }"
        // ── 查看器标签条 ──
        ...
        "  background: %13; color: %1; border: 1px solid %4;"
        "  border-radius: 3px; padding: 1px 6px 1px 10px;"
        ...
        "  background: none; width: 12px; height: 12px; border: none;"
